  ...
  <div class="min-h-full flex items-center justify-center">
    <div class="max-w-lg gap-12 justify-center lg:flex lg:max-w-none">
      <div class="max-w-lg mx-4 flex flex-col space-y-4">
        ...
        <p class="text-base-content"> 电脑义务维修中心于2015年9月创办以来, 是计算机学院学生党支部旗下的一支公益性特色服务团队,
          以电脑维修工作为重点, 以丰富校园科技文化为己任. 为切实弘扬志愿服务精神, 本中心无偿为全校师生提供电脑义务维修服务. </p>
        <div class="flex flex-wrap">
          <RouterLink to="/booking"
            class="btn btn-primary btn-soft mr-4 mb-4">
            预约维修 </RouterLink>
          <div class="join">
            <a href="https://qm.qq.com/q/flBStssyFa" class="btn btn-soft join-item" target="_blank">
              QQ咨询群 </a>
            <a href="https://doc.pcywwxzx.top" class="btn btn-soft join-item" target="_blank">
              维修文档 </a>
            <RouterLink to="/manage" class="btn btn-soft join-item">
              管理后台 </RouterLink>
          </div>
        </div>
      </div>
